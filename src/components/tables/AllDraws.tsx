...
function AllDraws({ includeFutureDraws }: { includeFutureDraws: boolean }) {
	...
	const rounds = includeFutureDraws ? [...activeRounds, ...oldRounds].sort((a, b) => b.finish - a.finish) : oldRounds;
