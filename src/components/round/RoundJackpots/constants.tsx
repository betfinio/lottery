...
export const JACKPOTS: JackpotRowItem[] = [
	{
		id: 'jackpot1',
		name: 'Jackpot 1',
		icon: <JackpotFrame animateStars className={'w-full h-full text-gold'} />,
	...
	},
	{
		id: 'jackpot3',
		name: 'Jackpot 3',
		icon: <JackpotFrame animateStars className={'w-full h-full text-silver'} />,
	...
	},
	{
		id: 'jackpot6',
		name: 'Jackpot 6',
		icon: <JackpotFrame animateStars className={'w-full h-full text-bronze'} />,
