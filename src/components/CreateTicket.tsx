...
const CreateTicket = () => {
	...
	return (
		<section className={'w-full h-full border-2 border-primary/70 rounded-xl p-2 md:p-3 bg-background-light col-span-3 md:col-span-1 create-shadow'}>
...
const TicketList = () => {
	...
	return (
		<AnimatePresence mode={'popLayout'}>
			<div className={'grid grid-rows-3 gap-2 py-4'}>
				...
				{draftTickets.length === 0 && <Ticket ticket={{ symbol: 0, numbers: [0, 0, 0, 0, 0] }} order={1} onEdit={(nt) => newTicket(nt)} isNew={true} />}
			</div>
